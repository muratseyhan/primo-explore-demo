...
angular.module('viewCustom').service('pickUpNumbers', [
  ...
  function($http, $location) {
     ...
     */
    this.insertPickUpNumbers = function(targetContainer, requests, selector) {
      console.log('Yes')
    ...
    this._insert = function(targetContainer, requests, selector) {
      let ctrl = this;
    ...
    this._composeRequestObjects = function(targetElements, requests) {
    ...
    this._insertForRequest = function(request) {
      let ctrl = this;
    ...
    this._retrievePickUpNumber = function(requestId) {
